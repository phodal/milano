...
define([
  ...
  var backSnowContainer, frontSnowContainer, images = {}, stage, preload;
  //雪花数组 用作回收
  var _snow1List = [];
  var _snow2List = [];
  var _snow3List = [];
  ...
  function Snow(originStage) {
    ...
    preload.loadManifest({src: 'assets/manifest/snow.manifest.json', type: 'manifest'});
    this.init();
  }
  ...
  Snow.prototype.action = function () {
  ...
  Snow.prototype.finish = function () {
